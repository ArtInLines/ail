...
// inline AIL_IdxBuffer ail_idxbuf_from_file(const char *filename);
// inline bool ail_idxbuf_copy_to_file(AIL_IdxBuffer buf, const char *filename);
// inline bool ail_idxbuf_to_file(AIL_IdxBuffer *buf, const char *filename);
inline AIL_IdxBuffer ail_idxbuf_from_data(u8 *data, u64 len, u64 idx, AIL_Allocator allocator);
inline AIL_IdxBuffer ail_idxbuf_new(u64 cap, AIL_Allocator allocator);
internal void ail_idxbuf_ensure_size(AIL_IdxBuffer *buf, u64 n);
inline void ail_idxbuf_free(AIL_IdxBuffer buf);
inline u8  ail_idxbuf_peek1   (AIL_IdxBuffer  buf);
inline u16 ail_idxbuf_peek2lsb(AIL_IdxBuffer  buf);
inline u32 ail_idxbuf_peek3lsb(AIL_IdxBuffer  buf);
inline u32 ail_idxbuf_peek4lsb(AIL_IdxBuffer  buf);
inline u64 ail_idxbuf_peek8lsb(AIL_IdxBuffer  buf);
inline u16 ail_idxbuf_peek2msb(AIL_IdxBuffer  buf);
inline u32 ail_idxbuf_peek3msb(AIL_IdxBuffer  buf);
inline u32 ail_idxbuf_peek4msb(AIL_IdxBuffer  buf);
inline u64 ail_idxbuf_peek8msb(AIL_IdxBuffer  buf);
