...
void *ail_alloc_ctx_alloc(size_t size);
void *ail_alloc_ctx_calloc(size_t nelem, size_t elsize);
void *ail_alloc_ctx_realloc(void *ptr, size_t size);
void ail_alloc_ctx_free(void *ptr);
void ail_alloc_ctx_free_all();
...
void *ail_alloc_arena_next_block(AIL_Alloc_Allocator allocator, size_t size, bool growable);
...
AIL_Alloc_Allocator ail_alloc_arena_init(AIL_Alloc_Allocator allocator, size_t initialSize, bool growable)
{
